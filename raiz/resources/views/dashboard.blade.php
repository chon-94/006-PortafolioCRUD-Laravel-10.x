<x-app-layout>
    ...
    <!-- Define el encabezado del layout -->
    <x-slot name="header"> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Dashboard') }} <!-- Título de la página del dashboard, traducido para soporte multilingüe -->
        </h2>
    </x-slot>
    {{-- Define el encabezado del layout --}}
    
    <!-- Espaciado vertical para el contenido -->
    <div class="py-12">
        
        <!-- Contenedor centrado y responsivo -->
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8"> 
            
            <!-- Caja del contenido principal -->
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg"> 
                <div class="p-6 text-gray-900 dark:text-gray-100">

                    <!-- Contenedor flex para layout en pantallas medianas y mayores -->
                    <div class="md:flex"> 
                        ...
                        <ul id="menu-list" class="flex-column space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
                            ...
                            <li data-tab="cards">
                                <a href="#" class="inline-flex items-center px-4 py-3 rounded-lg hover:bg-blue-200 hover:text-gray-900 w-full bg-blue-50 text-gray-500">
                                    ...
                                    <!-- Ícono SVG para actualizar el carrusel -->
                            ...
                            <li data-tab="single-card">
                                <a href="#" class="inline-flex items-center px-4 py-3 rounded-lg hover:bg-blue-200 hover:text-gray-900 w-full bg-blue-50 text-gray-500">
                                    ...
                                    <!-- Ícono SVG para manejar tres tarjetas -->
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                            ...
                            <li data-tab="create-user">
                                <a href="#" class="inline-flex items-center px-4 py-3 rounded-lg hover:bg-blue-200 hover:text-gray-900 w-full bg-blue-50 text-gray-500">
                                    ...
                                    <!-- Ícono SVG para tarjeta independiente -->
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                        ...
                        <div id="tab-content" class="p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full">
                            ...
                            <!-- Contenido para la pestaña de "Actualizar Carrusel" -->
                            <div id="cards" class="tab-content hidden">
                                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Actualizar Carrusel</h3>
                                <p>Contenido para actualizar el carrusel...</p>
                            </div>
                            {{-- Contenido para la pestaña de "Actualizar Carrusel" --}}

                            <!-- Contenido para la pestaña de "Manejar Tres Tarjetas" -->
                            <div id="single-card" class="tab-content hidden">
                                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Manejar Tres Tarjetas</h3>
                            ...
                            <!-- Contenido para la pestaña de "Opciones Futuras" -->
                            ...
                            <!-- Contenido para la pestaña de "Crear Usuario" -->
